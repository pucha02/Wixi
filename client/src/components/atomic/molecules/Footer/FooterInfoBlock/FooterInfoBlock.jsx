  ...
  return (
    <div className="footer-info-element-block">
      ...
      <div className="footer-info-element-bottom">
        ...
        <FooterElementText
          text={text.exchangeAndReturn.title}
          link={text.exchangeAndReturn.link}
        />
        <FooterElementText
          text={text.privacyPolicy.title}
          link={text.privacyPolicy.link}
        />
        <FooterElementText
          text={text.delivery.title}
          link={text.delivery.link}
        />
