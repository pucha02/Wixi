...
import { handleSaveDelivery } from '../../../../../utils/userDataOperations';
...
export const DeliveryInfo = () => {
                        ...
                        if (initialCity) {
                            ...
                            axios
                                ...
                                .then(response => {
                                    ...
                                    const initialWarehouse = warehousesData.find(w => w.label === warehouse);
                                    if (initialWarehouse) {
    ...
    return (
        <div className="delivery-info-profile-block">
            <form className="delivery-info-profile-selects" onSubmit={(e)=>handleSaveDelivery(e, selectedArea, selectedCity, selectedWarehouse)}>
                <Select
                    options={areas}
                    value={selectedArea}
