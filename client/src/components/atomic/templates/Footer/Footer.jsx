        ...
        <div className="bottom-footer">
          <div className="bottom-footer-col">
            <FooterContactElement
              headtext={"Контакти"}
              text={"+38 (099) 011 01 11"}
              src={FooterPhone}
            />
            <FooterContactElement
              headtext={"Email"}
              text={"wixi_brend@gmail.com"}
              src={FooterEmail}
            />
          </div>
          <div className="bottom-footer-col">
            <FooterContactElement
              headtext={"Наша адреса"}
              text={"Україна, м. Місто, вул. Вулиця, 10"}
              src={FooterAdress}
            />
            <FooterContactElement
              headtext={"Графік роботи"}
              text={"Працюємо щодня з 9 до 21"}
              src={FooterClock}
            />
          </div>
          <div className="bottom-footer-col">
