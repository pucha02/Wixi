              ...
              <div className="order-summary">
                <div className="order-info comp">
                  <div className="order-info-images">
                    ...
                    {order.products[1]?.img && (
                      <img src={order.products[1].img} alt="" />
                    )}
                    {order.products[2]?.img && (
                      <img src={order.products[2].img} alt="" />
                    )}
                  </div>
                ...
                <div className="order-info mob">
                  ...
                  {/* Проверка наличия первого изображения */}
                  {order.products[1]?.img && (
                    <img src={order.products[1].img} alt="" />
                  )}
                  {order.products[2]?.img && (
