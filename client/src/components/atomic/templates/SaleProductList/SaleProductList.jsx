...
const SaleProductList = ({ viewMobileFilter, setViewMobileFilter }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const result = await getProductByType("sale");
    ...
    return (
        <div className="catalog-container">
            <div className="category-title"><Link to={'/'}>ГОЛОВНА</Link> / <Link to={`/saleproducts`}>ЗНИЖКИ</Link></div>
