...
//       setSelectedImage(images[0]?.img_link || NoImg);
//     } else {
...
//     setSelectedImage(img.img_link || NoImg);
...
const ImageSlider = ({ images }) => {
  ...
  const handleMouseMove = (e) => {
    if (!mainImageRef.current || isMobile) return; // Отключаем приближение на мобильных устройствах
