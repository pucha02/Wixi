...
import AllProductList from "../../atomic/templates/AllProductsList/AllProductsList"
        ...
        <>
            ...
            <div className="main">
                ...
                <div className="product-list-block">
                    <AllProductList viewMobileFilter={viewMobileFilter} setViewMobileFilter={setViewMobileFilter} />
                </div>
