export const fetchDataUser = async (setUser, setOrderDetails, setIsLoading) => {
  ...
  try {
    const response = await fetch(
      "http://localhost:5001/api/auth/get-information-for-user-account",
      {
        method: "GET",
        headers: {
...
export const handleSave = async (e, setUser, orderDetails) => {
  ...
  try {
    const response = await fetch(
      "http://localhost:5001/api/auth/update-user-information",
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export const handleSaveDelivery = async (
  e,
  selectedArea,
  selectedCity,
  selectedWarehouse
  ...
  try {
    const response = await fetch(
      "http://localhost:5001/api/auth/update-delivery-information",
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
